...
def a_star(prolog_thread, start, goal):
    ...
    while priority_queue:
        ...
        successors = get_successors(prolog_thread, current)
        for successor in successors:
            tentative_g_score = g_score[current] + get_distance(prolog_thread, current, successor)
            ...
            if successor not in g_score or tentative_g_score < g_score[successor]:
                ...
                new_path = path + [successor]
                heapq.heappush(priority_queue, (f_score, tentative_g_score, successor, new_path, tentative_g_score))
